...
const ResizeTextArea = ({sisus,id=0,save,placeholder="",edit=false,avaa}) => {
    ...
    useEffect(() => {
      ...
      Tarea.current.style.minHeight = (Tarea.current.scrollHeight-15)+'px'}, [])  
      ...
      else sisusta = <div ref={Tarea} tabIndex="0" style={{paddingBottom:15}} className="areaText" id={id} spellCheck="false" >{sisus}</div>
